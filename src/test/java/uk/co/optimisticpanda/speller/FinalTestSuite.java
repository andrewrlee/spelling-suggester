...
public class FinalTestSuite {
	...
	private static File testFile = new File("src/test/resources/test2.txt");
	...
	public FinalTestSuite(String input, String correctAnswer) {
	...
	@Parameters()
	public static Collection values() throws IOException {
